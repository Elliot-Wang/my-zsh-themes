...
YS_THEME_PROXY_PROMPT_PREFIX=" %{$fg[green]%}"
YS_THEME_PROXY_PROMPT_SUFFIX=" %{$reset_color%}%"
proxy_prompt() {
    [ "${http_proxy:+x}" ] && echo "${YS_THEME_PROXY_PROMPT_PREFIX}PxOn${YS_THEME_PROXY_PROMPT_SUFFIX}"
}
